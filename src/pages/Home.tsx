...
const TARIFFS: Tariff[] = [
  {
    ...
    features: [
      { text: "Решение точечного запроса" },
      { text: "Стратегическая сессия" },
    ],
    price: 3250,
    priceOld: 7500,
    discountPercent: 50,
  ...
  },
  {
    ...
    features: [
      { text: "12 тематических встреч (2–2,5 часа)" },
      { text: "1 встреча в неделю в фиксированный день" },
      { text: "Закрытая группа с постоянным составом" },
      { text: "Поддержка и общение в чате группы" },
      { text: "Каждая встреча: теория, групповая практика, разбор" },
    ],
    price: 35700,
    priceOld: 51000,
    discountPercent: 30,
  ...
  },
  {
    ...
    features: [
      { text: "1 сессия в неделю, 1,5 ч, 10 сессий" },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Трёхразовое здоровое веганское питание" },
      { text: "Проживание с раздельными спальными местами" },
      { text: "Баня с купелями и чаном" },
      { text: "Йога" },
      { text: "Медитация" },
      { text: "Чайная церемония" },
      { text: "Пт. 14:00–17:00 — заезд, Вс. 12:00–14:00 — отъезд" },
    ],
    price: 45500,
    priceOld: 65000,
    discountPercent: 30,
